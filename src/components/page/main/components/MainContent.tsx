...
export const MainContent: FC<MainPageProps> = ({
  ...
  return (
    <Box mx="1rem">
      ...
      <Box textAlign="right">
        <Button mt="1rem" onClick={onClickSellingPriceCalculate}>
          計算する
        </Button>
      </Box>
      ...
      <Flex mt="2rem">
        <Stat borderWidth={1} p="1rem">
          <StatLabel>メルカリ</StatLabel>
          <StatNumber>{`￥${profit1.merukari.sellingPrice}`}</StatNumber>
          <StatHelpText>{`手数料￥${profit1.merukari.commission}`}</StatHelpText>
          <StatHelpText>{`配送料￥${profit1.merukari.fee}`}</StatHelpText>
        </Stat>
        <Stat borderWidth={1} p="1rem">
          <StatLabel>ラクマ</StatLabel>
          <StatNumber>{`￥${profit1.rakuma.sellingPrice}`}</StatNumber>
          <StatHelpText>{`手数料￥${profit1.rakuma.commission}`}</StatHelpText>
          <StatHelpText>{`配送料￥${profit1.rakuma.fee}`}</StatHelpText>
        </Stat>
        <Stat borderWidth={1} p="1rem">
          <StatLabel>PayPayフリマ</StatLabel>
          <StatNumber>{`￥${profit1.paypay.sellingPrice}`}</StatNumber>
          <StatHelpText>{`手数料￥${profit1.paypay.commission}`}</StatHelpText>
          <StatHelpText>{`配送料￥${profit1.paypay.fee}`}</StatHelpText>
        </Stat>
      </Flex>
    </Box>
  );
